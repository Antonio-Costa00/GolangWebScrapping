<h3 align="center" >
  Web Scraper criado em Golang responsável por coletar todas as promoções da promoção de Black Friday do site https://www.mercadolivre.com.br e armazenar os dados em um arquivo .csv, realizando a comparação do valor antigo e o novo, mostrando a real redução de preço para cada produto. 
</h3>
